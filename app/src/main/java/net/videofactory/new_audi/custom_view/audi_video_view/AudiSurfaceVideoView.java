...
/**
 * Created by Utae on 2016-03-13.
 */
public class AudiSurfaceVideoView extends SurfaceView implements AudiMediaController.MediaPlayerControl {
    ...
    private AudiMediaController mMediaController;
    ...
    public AudiSurfaceVideoView(Context context) {
        super(context);
        initVideoView();
    }

    public AudiSurfaceVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initVideoView();
    }

    public AudiSurfaceVideoView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setMediaController(AudiMediaController controller, VideoDetailInfo videoDetailInfo) {
...
//        mMediaController.hide();
//        attachMediaController();
//        mMediaController.setVideoDetailInfo(videoDetailInfo);
...
//                        mMediaController.show(0);
    ...
    private MediaPlayer.OnErrorListener mErrorListener =
            new MediaPlayer.OnErrorListener() {
                public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
                    Utilities.logD(TAG, "Error: " + framework_err + "," + impl_err);
                    mCurrentState = STATE_ERROR;
                    mTargetState = STATE_ERROR;
                    if (mMediaController != null) {
                        mMediaController.hide();
    ...
    public void releaseMediaController(){
        ViewGroup anchorView = (ViewGroup)this.getParent();
        anchorView.removeView(mMediaController);
